...
.PHONY: disass
disass:
	z80dasm -z -a -l -t -g 0xFE10 ${SRC_DIR}/ceas65040.bin > ${BUILD_DIR}/ceas65040.lst
	z80dasm -z -a -l -t -g 0xF7F7 ${SRC_DIR}/ceas63479.bin > ${BUILD_DIR}/ceas63479.lst
